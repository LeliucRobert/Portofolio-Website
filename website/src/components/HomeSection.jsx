...
import pozaImage from './poza.jpeg';



const HomeSection = () => {
    const phrases = ['Software Developer', 'Computer Science Student', 'Web Developer', 'Software Engineer'];
    const sleepTime = 100;
        ...
        <div className="HomeSectionText1">
            <div className="HomeSectionText">
                ...
                <div className="HomeSectionAnimatedText">
                    <span id="TypeWritter" ref={elRef} className="TypeWritter"> </span>
            ...
            <img src={pozaImage} alt="Image description" />
